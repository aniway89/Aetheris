  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="text-xs text-neutral-400 font-semibold mb-2">Account setting</div>
          <Link href={'Setting/ProfileEdit'} className='flex items-center bg-neutral-900 px-4 py-3 border border-neutral-800 rounded-xl hover:bg-neutral-800 transition  justify-between'>
          ...
          <Link href={'/'} className='flex items-center bg-neutral-900 px-4 py-3 border border-neutral-800 rounded-xl hover:bg-neutral-800 transition justify-between '>
           <div className="flex items-center gap-5 text-neutral-200 ">
            <IoMailOutline
