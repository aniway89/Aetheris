...
const Profile = () => {
  return (
    <div className="flex-col flex w-full h-full items-center relative">

      <div className='flex flex-col h-full overflow-y-auto scollabar-hide'>
        <div className="w-full h-40 overflow-hidden  flex items-center justify-center relative flex-shrink-0">
        ...
        <div className="username-area w-full flex flex-col px-4 ">
          <div className="DisplayName text-base  font-semibold ">
            !Yoru.Ayan.lEgend
          </div>
          <div className=" w-full flex items-center text-neutral-400 gap-1">
            <div className="Username text-xs  max-w-[150px]  ">
              @ayan124
            </div>
        ...
        <div className="p-4">
          <div className="flex flex-col gap-1">
            <div className="text-[10px] text-neutral-400 font-semibold">About Me</div>
            <div className="bg-neutral-900 px-4 py-2 border border-neutral-800 rounded-xl text-neutral-300 text-sm">
